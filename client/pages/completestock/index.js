...
<div> <br /> Current Page: {page}</div> <br />
      <button
				...
				<Table aria-label='Complete stock table'>
					<TableHead>
						<TableRow>
							...
							<StyledTableCell align='right'> Current stock value (SAR):</StyledTableCell>
					...
					<TableBody>
						{data.data.map((row) => (
							<StyledTableRow key={row._id}>
								...
								<StyledTableCell align='right'>{row['receipt-val']}</StyledTableCell>
								<StyledTableCell align='right'>{row['issue-val']}</StyledTableCell>
								<StyledTableCell align='right'>
									{row['current-stkval']}
								</StyledTableCell>
