...
export const StockCard = ({ completestk }) => {
					...
					<TableBody>
						{completestk.map((row) => (
							<TableRow key={row._id}>
								...
								<TableCell align='right'>{row['current-stkqty']}</TableCell>
								<TableCell align='right'>{row['current-stkval']}</TableCell>
